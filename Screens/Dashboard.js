...
import {dummyData} from '../NavScreens/constants'
import { ProfitIndicator,ActionCenter } from './TeshDash'
        ...
        <View style={{flex:1}} >
            ...
            <LinearGradient start={{x:0.0,y:0.4}} end={{x:0.5,y:1.0}} location={[0,1]} colors={['#2D97DA','#2249D6']} style={{flex:1.2,flexDirection:'column'}} >
                ...
                <View style={{flexDirection:'row',justifyContent:'space-between',alignItems:'flex-start'}} >
                    ...
                    <View style={{flexDirection:'row',alignItems:'center'}} >
                        ...
                        <Image source={require('../src/assets/images/avatar.jpg')} resizeMode='cover' style={{width:40,height:40,borderRadius:20,marginLeft:15}} />
                    </View>
                </View>
            ...
            <View style={{flex:2.5,backgroundColor:'#fff',paddingHorizontal:wp('5%')}} >
                ...
                <View style={{flexDirection:'row',backgroundColor:'#fff',height:hp('13%'),width:'100%',alignItems:'center',justifyContent:'space-around',borderRadius:10,borderWidth:1,borderColor:'rgba(255,255,255,0.1)',elevation:10,shadowColor:'#000',shadowRadius:10,marginTop:-25}} >
                    ...
                    <ActionCenter img_src={require('../src/assets/icons/top-up.png')} img_text="Top-Up" />

                    <ActionCenter img_src={require('../src/assets/icons/buy.png')} img_text="Buy" />

                    <ActionCenter img_src={require('../src/assets/icons/withdraw.png')} img_text="WithDraw" />
