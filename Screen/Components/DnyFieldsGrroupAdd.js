...
export function AddFiledFroup({
  ...
  return (
    <ScrollView>
      ...
      {/* Mainflex */}
      <View>
        {/* Group Head and Removebutton  */}
        <View style={styles.fl_rw_spbtwn}>
          <Text styles={{ marginRight:'20', color: "red" }}>
            GroupID {index + 1}
          </Text>
          <TouchableOpacity            
            onPress={() => {
